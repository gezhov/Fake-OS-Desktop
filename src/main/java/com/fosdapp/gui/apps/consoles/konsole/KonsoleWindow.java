...
public class KonsoleWindow extends WindowPanel {
    // потенциально здесь могут быть добавлены панели для меню и toolbar'а
    ...
    public KonsoleWindow(String appIconResource, String appTitle, int width, int height) {
